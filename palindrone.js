...
(function (undefined) {
  ...
  palindrone.prototype = {
    ...
    findPalindromicSequences: function(){
      for(iteratorStart = 0; iteratorStart < palindrone.searchedSequenceLength - 2; iteratorStart ++){
        for(iteratorEnd = iteratorStart + 1; iteratorEnd < palindrone.searchedSequenceLength; iteratorEnd ++){
